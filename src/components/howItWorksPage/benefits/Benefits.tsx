...
const Benefits: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      className="w-11/12 lg:w-9/12 flex flex-wrap justify-start ssm:justify-center items-center gap-x-12 text-large-medium  lg:text-extera-large-medium z-10 mt-32">
      ...
      <div className="sm:w-11/12 lg:w-9/12 h-52 mt-8 ssm:mt-16 flex z-10">
