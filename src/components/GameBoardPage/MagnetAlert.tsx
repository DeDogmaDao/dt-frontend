...
const MagnetAlert: React.FC<props> = ({ currentCard }) => {
  ...
  return (
    <div
      className={`absolute top-[8vw] left-[30vw] h-[3vw] w-[7vw] text-[1.5vw] font-bold duration-1000 select-none cursor-default
    ...
    >
      <p className={`duration-1000 select-none ${on > 2 && "animate-glowText"}`}>Magnet</p>
    </div>
  );
};
