    ...
    <div className="absolute top-0 left-0 w-full h-[5.25rem] z-[10000] pointer-events-none">
      <div className="flex justify-start items-center w-full h-full relative">
        ...
        <a
          href={gitbookLink}
          target="_blank"
          className="z-50 pointer-events-auto absolute top-[2rem] right-[5rem] px-2 ssm:w-[8.5rem] h-10 rounded-full bg-neutral-600 text-white text-sm font-bold 
        ...
        <a
          href={discordLink}
          target="_blank"
          className="z-50 absolute cursor-pointer pointer-events-auto top-[2rem] right-[2rem] w-10 h-10 rounded-full bg-neutral-600
