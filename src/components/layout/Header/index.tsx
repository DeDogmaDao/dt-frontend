  ...
  return (
    <div className=" w-full h-[5.25rem] z-[10000] pointer-events-none">
      <div className="flex justify-start items-center w-full h-full relative">
        ...
        <button
          className=" pointer-events-auto absolute top-[2rem] right-[7.7rem] w-[8.5rem] h-10 rounded-full bg-neutral-700 text-white text-sm font-bold 
    flex justify-evenly items-center"
        ...
        <button className="absolute pointer-events-auto top-[2rem] right-[4.5rem] w-10 h-10 rounded-full bg-neutral-700 text-white text-xl flex justify-center items-center">
          <DiscordSVG />
        </button>
