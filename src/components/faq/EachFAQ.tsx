...
const EachFAQ: React.FC<props> = ({ data }) => {
  ...
  return (
    <motion.li layout className="w-11/12 group z-10 rounded-lg overflow-hidden shadow-md hover:shadow-inner">
      <div
      ...
      >
        ...
        >
          ...
          <span
            className={`bg-secondary-500 text-white rounded-full !h-16 !w-16 !min-w-[64px] ml-3 flex justify-center items-center  group-hover:rotate-90 group-hover:bg-secondary-400 duration-500
